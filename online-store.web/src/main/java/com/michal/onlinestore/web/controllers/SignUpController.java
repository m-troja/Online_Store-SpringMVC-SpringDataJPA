...
import static com.michal.onlinestore.web.filters.PartnerCodeFilter.PARTNER_CODE_COOKIE_NAME;
...
public class SignUpController {
	...
	@PostMapping
	public String doPost(@Valid @ModelAttribute("user") User user, BindingResult br, HttpSession session, HttpServletRequest request,
		...
		if (!notEncryptedPassword.equals(user.getPassword())) {
		...
		user.setPassword(encryptionService.encode(notEncryptedPassword));
